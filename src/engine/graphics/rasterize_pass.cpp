...
Rasterizer::Rasterizer(std::shared_ptr<DeviceCom> deviceCom)
:
_device(deviceCom) {}

bool Rasterizer::Initiate() {
...
bool Rasterizer::BuildRootSignature() {
...
bool Rasterizer::BuildPipelineState() {
    {
        /*OPAQUE PSO*/
        ...
        pso_desc.VS = {reinterpret_cast<BYTE *>(Shader::RasterizePass.VS->GetBufferPointer()),
                       Shader::RasterizePass.VS->GetBufferSize()};

        pso_desc.PS = {Shader::RasterizePass.PS->GetBufferPointer(),
                       Shader::RasterizePass.PS->GetBufferSize()};
...
bool Rasterizer::BuildResourceBuffer() {
